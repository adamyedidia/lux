...
vidtype = '.MP4';
gridfile = fullfile(expfolder, strcat('calibrationgrid', vidtype));


names = {'redblue2_walking', 'red12_walking', 'redblue1_walking'};
...
for n = 1:length(names)
    try
        ...
        fprintf('ERROR while processing %s: %s', name, error);
    end
end
